...
public class MenstrualRevolution1{
    ...
    public MenstrualRevolution1(String name, String gender, int age, int lastDay, int length){
        MenstrualRevolution1.name = name;
        MenstrualRevolution1.gender = gender;
        MenstrualRevolution1.age = age;
        MenstrualRevolution1.lastDay = lastDay;
        MenstrualRevolution1.length = length;
    }
